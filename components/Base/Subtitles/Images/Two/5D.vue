<template>
	<div v-if="isActive('xs', '5D')" class="container mx-auto grid grid-cols-6 gap-x-5">
	...
	<div v-if="isActive('s', '5D') || isActive('m', '5D') || isActive('l', '5D') || isActive('xl', '5D')" class="container mx-auto grid grid-cols-12 gap-x-5">
		<template v-for="(item, key) in items">
